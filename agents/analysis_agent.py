...
class AnalysisAgent:
    ...
    def _boardings(self, e: dict) -> dict:
        ...
        summary = (
            f"Top stops by boardings:\n" +
            result[["stop_nm", "total_boardings", "total_alightings"]].to_string(index=False)
        )
        return {
            "data": result, 
            "table": result, 
    ...
    def _crowding(self, e: dict) -> dict:
        ...
        summary = f"Crowding analysis by route & time period:\n" + result.to_string(index=False)
        return {
            "data": result, 
            "table": result, 
            "summary": summary,
    ...
    def _schedule_adherence(self, e: dict) -> dict:
        ...
        summary = f"Schedule adherence by route:\n" + result.to_string(index=False)
        return {
            "data": result, 
            "table": result, 
            "summary": summary,
    ...
    def _route_comparison(self, e: dict) -> dict:
        ...
        summary = f"Inbound vs Outbound comparison:\n" + result.to_string(index=False)
        return {
            "data": result, 
            "table": result, 
            "summary": summary,
    ...
    def _stop_performance(self, e: dict) -> dict:
        ...
        summary = f"Underperforming stops (lowest boardings):\n" + result.to_string(index=False)
        return {
            "data": result, 
            "table": result, 
            "summary": summary,
    ...
    def _geographic(self, e: dict) -> dict:
        ...
        summary = f"Geographic ridership by zone/zip:\n" + result.to_string(index=False)
        return {
            "data": result, 
            "table": result, 
            "summary": summary,
